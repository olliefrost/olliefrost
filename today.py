...
def cache_filename():
    """
    Returns the unique cache filename for the current user
    """
...
def svg_overwrite(filename, age_data, commit_data, loc_data):
    """
    Parse SVG files and update elements with my age, commits, and lines written
    """
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2006, 10, 6))
